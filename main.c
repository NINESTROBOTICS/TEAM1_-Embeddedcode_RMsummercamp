...
osThreadId test2Handle;

osThreadId refereeHandle;
osThreadId referee_sendHandle;
...
extern void test_task2(void const * argument);
...
int main(void)
{
  ...
  /* add threads, ... */
  osThreadDef(ins_task, INSTask, osPriorityRealtime, 0, 256);
  ins_taskHandle = osThreadCreate(osThread(ins_task), NULL);


  osThreadDef(cali_task, calibrate_task, osPriorityNormal, 0, 256);
  ...
  chassis_distance_send_taskHandle = osThreadCreate(osThread(chassis_send), NULL);
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////
	osThreadDef(test, test_task, osPriorityHigh, 0, 256);
  testHandle = osThreadCreate(osThread(test), NULL);
	
	osThreadDef(test2, test_task2, osPriorityHigh, 0, 256);
  test2Handle = osThreadCreate(osThread(test2), NULL);
	
	osThreadDef(referee, referee_task, osPriorityHigh, 0, 256);
  refereeHandle = osThreadCreate(osThread(referee), NULL);
	
	osThreadDef(referee_send, referee_send_task, osPriorityHigh, 0, 256);
  referee_sendHandle = osThreadCreate(osThread(referee_send), NULL);
...
//  htim2.Init.AutoReloadPreload = TIM_AUTORELOAD_PRELOAD_DISABLE;
  ...
  /* USER CODE BEGIN TIM2_Init 2 */
	...
	__HAL_TIM_SetCompare(&htim2,TIM_CHANNEL_1,790);
	__HAL_TIM_SetCompare(&htim2,TIM_CHANNEL_2,1450);
	__HAL_TIM_SetCompare(&htim2,TIM_CHANNEL_3,755);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, SPI5_NSS_Pin|LED_GREEN_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin : SHOOT_INPUT_Pin */
  GPIO_InitStruct.Pin = SHOOT_INPUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(SHOOT_INPUT_GPIO_Port, &GPIO_InitStruct);
...
__weak void led_trigger_task(void const * argument)
{
